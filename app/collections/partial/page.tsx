...
export default async function CollectionsPartialPage({ searchParams }: { searchParams?: { groupId?: string } }) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold">Taxes partiellement payees</h1>
        <p className="text-sm text-muted-foreground">Factures fiscales avec paiements partiels.</p>
      </div>

      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-semibold">Avis partiels</h2>
